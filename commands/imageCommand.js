...
async function terreract(client, message) {
    ...
    const worker = createWorker({
      ...
      (async () => {
        ...
        const { data: { text } } = await worker.recognize(`https://cdn.discordapp.com/attachments/798589450774511676/804237333426995200/unknown.png`);
        console.log(text);
